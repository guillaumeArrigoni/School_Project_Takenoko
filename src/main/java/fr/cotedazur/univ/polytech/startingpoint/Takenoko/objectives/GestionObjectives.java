...
public class GestionObjectives {
    ...
    public TypeObjective chooseTypeObjectiveByCheckingUnknownObjectives(Bot bot){
        ...
        int[] moyennePointsObjectives = new int[3];
        ...
        if(sizeParcellle != 0) {
            ...
            moyennePointsObjectives[0] /= sizeParcellle;
        }
        if(sizeJardinier != 0) {
            numberOfTypeObjectiveDone[1] /= sizeJardinier;
            moyennePointsObjectives[1] /= sizeJardinier;
        }
        if(sizePanda != 0) {
            numberOfTypeObjectiveDone[2] /= sizePanda;
            moyennePointsObjectives[2] /= sizePanda;
        }
